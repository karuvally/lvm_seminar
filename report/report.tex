...
your precious data with them. Backing up data is an option, but what if you want to
save the current state of your storage? This is where disk imaging comes into
...
as CloneZilla. Which means, you guessed it right, more downtime.\\
...
create images of your entire storage which can be used to restore the disks to
the state at the time of creation of the snapshot.
