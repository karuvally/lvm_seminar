...
the rest of the partitions. The process of creating partitions to store data on
a storage device is called disk partitioning. Apparently, ghosts of optical and
magnetic storage media are going to haunt us for a very long time. There is
quite a bit of interesting things about disk partitioning, which you can read
