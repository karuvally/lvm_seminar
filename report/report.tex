...
performance, reliability or both. RAID provides a number of features that are
similar to the ones provided by LVM, but differences exist, which are discussed
in this chapter.
