...
at least a couple of file systems, if you have used a computer. Windows machines
normally use NTFS as its file system. Linux people prefer to use ext4 or btrfs.
If you own a USB drive, it most probably uses the FAT32 file system.
